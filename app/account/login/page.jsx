...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    toast.success(isLogin ? "Login Successful! Welcome back!" : "Registration Successful! account has been created")

    // Redirect to account page (in a real app)
    // router.push('/account');
  }
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mt-2">
                  {isLogin
                    ...
                    : "Join Kumhar to start shopping for beautiful furniture"}
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <input
                        ...
                        name="remember-me"
                        type="checkbox"
                        className="h-4 w-4 text-[#1080b0] focus:ring-[#1080b0] border-gray-300 rounded"
                      />
                    ...
                    <div className="text-sm">
                      <Link href="/account/forgot-password" className="font-medium text-[#1080b0] hover:underline">
                        Forgot password?
                      </Link>
                    </div>
                  </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-[#1080b0] text-white py-3 rounded-md font-medium hover:bg-[#0c6a8e] transition-colors"
                >
              ...
              <p className="mt-6 text-center text-sm text-gray-600">
                ...
                <button type="button" onClick={toggleView} className="font-medium text-[#1080b0] hover:underline">
