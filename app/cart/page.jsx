...
export default function CartPage() {
  ...
  const calculateTotal = () =>
    calculateSubtotal() + calculateTax() + calculateShipping() - discount;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow py-8 bg-[#f8f9fa]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-[#1080b0] mb-6">
            Shopping Cart
          </h1>
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                  <div className="p-6 border-b">
                    <h2 className="text-xl font-semibold">
                      Cart Items ({fullCartItems.length})
                    </h2>
                  </div>
                  ...
                  <div>
                    {fullCartItems.map((item) => (
                      <div
                        key={item.id}
                        className="p-6 border-b flex flex-col sm:flex-row gap-4"
                      >
                        ...
                        <div className="flex-grow">
                          <div className="flex justify-between">
                            <Link
                              ...
                              className="font-semibold text-lg hover:text-[#1080b0]"
                            >
                              {item.name}
                            </Link>
                            <button
                          ...
                          <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex items-center">
                              ...
                              <button
                                ...
                                className="p-1 border rounded-r-md bg-gray-50 text-gray-600 hover:bg-gray-100"
                              >
                                <Plus size={16} />
                              </button>
                            </div>
                  ...
                  <div className="p-6 flex justify-between items-center">
                    <Link
                      href="/shop"
                      className="text-[#1080b0] hover:underline flex items-center"
                    >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex">
                      <input
                        ...
                        placeholder={
                          promoApplied ? "WELCOME10 Applied" : "Enter promo code"
                        }
